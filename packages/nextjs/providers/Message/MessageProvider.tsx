...
import { ChatMessage, MessagesOutgoing, MessagesOutgoingType } from "~~/providers/Message/message-server";
import { useSocket, useSocketMessage } from "~~/providers/Socket/SocketProvider";
...
export function MessageProvider({ children }: { children: ReactNode }) {
  ...
  useSocketMessage<ChatMessage>((obj: any) => {
    setChatMessages([obj]);
