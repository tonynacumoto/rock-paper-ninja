...
export type PartyKitServerWithMoreFun = {
  onConnect: (conn: PartyKitConnectionWithMoreFun, room: PartyKitRoomWithMoreFun) => void;
  onClose: (conn: PartyKitConnectionWithMoreFun, room: PartyKitRoomWithMoreFun) => void;
  onMessage: (msg: string | ArrayBuffer, conn: PartyKitConnectionWithMoreFun, room: PartyKitRoomWithMoreFun) => void;
  onConnectExtended: (conn: PartyKitConnectionWithMoreFun, room: PartyKitRoomWithMoreFun) => void;
  onCloseExtended: (conn: PartyKitConnectionWithMoreFun, room: PartyKitRoomWithMoreFun) => void;
  onMessageExtended: (
